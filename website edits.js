...
const texts = {
    ar: {
        ...
        hist_mohe_desc: "أصبح المعهد تحت إشراف وزارة التعليم العالي والمعاهد بجمهورية مصر العربية والدول العربية والأفريقية بالكامل، وتم تعديل المسمى لتقديم دورات تثقيفية مكثفة لشباب الجامعات.",
