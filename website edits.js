...
const texts = {
    ar: {
        ...
        doc_kareem_desc: "الأستاذ الدكتور كريم حسن همام أستاذ تنظيم المجتمع بكلية الخدمة الاجتماعية بجامعة العاصمة (حلوان سابقاً)، ومستشار وزير التعليم العالي للأنشطة الطلابية، ومدير معهد إعداد القادة بحلوان.",
        doc_mohamed: " دكتور جامعي محمد عبدالفتاح",
        doc_mohamed_desc: "الأستاذ المساعد الدكتور محمد عبدالفتاح أستاذ مساعد بكلية الخدمة الاجتماعية بجامعة العاصمة (حلوان سابقًا)، ووكيل مدير معهد إعداد القادة.",
