...
const texts = {
    ar: {
        ...
        doc_kareem_desc: "الأستاذ الدكتور كريم حسن همام أستاذ تنظيم المجتمع بكلية الخدمة الاجتماعية بجامعة العاصمة، ومستشار وزير التعليم العالي للأنشطة الطلابية، ومدير معهد إعداد القادة.",
        doc_mohamed: "أ.م.د محمد عبدالفتاح",
        doc_mohamed_desc: " استاذ التخطيط الاجتماعي و مساعد بكلية الخدمة الاجتماعية بجامعة العاصمة، ووكيل مدير معهد إعداد القادة",
