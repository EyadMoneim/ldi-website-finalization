...
const texts = {
    ar: {
        ...
        doc_kareem_desc: "ا.د. كريم همام هو شخصية بارزة في قطاع التعليم العالي والخدمة الاجتماعية في مصر، يشغل مناصب هامة مثل مستشار وزير التعليم العالي والبحث العلمي للأنشطة الطلابية، ومدير معهد إعداد القادة، وأستاذ بكلية الخدمة الاجتماعية بجامعة حلوان.",
