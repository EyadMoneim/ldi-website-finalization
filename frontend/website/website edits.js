...
const texts = {
    ar: {
        ...
        doc_kareem_desc: "أ.د. كريم حسن همام هو شخصية بارزة في قطاع التعليم العالي، يشغل مناصب هامة مثل مستشار وزير التعليم العالي والبحث العلمي للأنشطة الطلابية، ومدير معهد إعداد القادة، وأستاذ بكلية الخدمة الاجتماعية بجامعة العاصمة (حلوان سابقا).",
