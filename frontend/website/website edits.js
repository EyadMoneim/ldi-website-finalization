...
const texts = {
    ar: {
        ...
        "org-chart-title": "الهيكل الاداري للمعهد",
        ...
        "it-box": "إدارة<br>تكنولوجيا<br>المعلومات",
        "security-box": "الأمن",
        ...
        // === Icons (HTML Strings) ===
        location_icon: '<img src="https://rbjkis7zqx.ufs.sh/f/4UPD8CWlzrFkI0EwG0U8pXjzdtMN3RAgC7lkfnEHZUo0Bx2w" class="contact-icon">',
        Phone_Icon: '<img src="https://rbjkis7zqx.ufs.sh/f/4UPD8CWlzrFkoNdxgfq7cl5m2vuys4Jrw3GjeXRAHPxE08IV" class="contact-icon">',
        Email_Icon: '<img src="https://rbjkis7zqx.ufs.sh/f/4UPD8CWlzrFke1oVAuOfjYguoCiIUFG52Da7ZctkWhwnsLJp" class="contact-icon">',
        facebook_icon: '<img src="https://rbjkis7zqx.ufs.sh/f/4UPD8CWlzrFk2H4wNLmMAFVf6kCey57jWLIRpT3dU9uHZDvm" class="contact-icon">',
        instagram_icon: '<img src="https://rbjkis7zqx.ufs.sh/f/4UPD8CWlzrFkOdzQMCNqptTVisPyfaEW3LAZjCGhrgvRKMuc" class="contact-icon">',
        tiktok_icon: '<img src="https://rbjkis7zqx.ufs.sh/f/4UPD8CWlzrFkesWcHPfjYguoCiIUFG52Da7ZctkWhwnsLJpM" class="contact-icon">',
        linkedin_icon: '<img src="https://rbjkis7zqx.ufs.sh/f/4UPD8CWlzrFkc7NQY7BNJF2HCk97wLpGQza1Wm0TtAYXUPoR" class="contact-icon">',
        youtube_icon: '<img src="https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/youtube-app-white-icon.png" class="contact-icon">',

        event1: "البرنامج التدريبي التنسيقي لمنسقي المشروع الوطني للقراءة",
        descEvent1: "يأتي البرنامج التدريبي التنسيقي للمشروع الوطني للقراءة في إطار التعاون بين وزارة التعليم العالي والبحث العلمي والمشروع الوطني للقراءة، بهدف إعداد منسقين قادرين على نشر ثقافة القراءة داخل الجامعات، وتعزيز وعي الطلاب، وترسيخ القراءة كمسار أساسي لبناء الإنسان وصناعة الفكر.",
        event2: 'البرنامج التدريبى "سفراء الوطن" لأعضاء هيئة التدريس المبعوثين للخارج',
        ...
        doc_kareem_desc: "الأستاذ الدكتور كريم حسن همام أستاذ تنظيم المجتمع بكلية الخدمة الاجتماعية بجامعة العاصمة (حلوان سابقاً)، ومستشار وزير التعليم العالي للأنشطة الطلابية، ومدير معهد إعداد القادة بحلوان. يتمتع بخبرة طويلة في مجال العمل الطلابي وتنمية القيادات الشبابية، وله إسهامات بارزة في دعم وتطوير الأنشطة الطلابية على مستوى الجامعات المصرية.",
        doc_mohamed: "أ.م. محمد عبدالفتاح",
        doc_mohamed_desc: "الأستاذ المساعد الدكتور محمد عبدالفتاح أستاذ مساعد بكلية الخدمة الاجتماعية بجامعة العاصمة (حلوان سابقًا)، ووكيل مدير معهد إعداد القادة. يشارك في تطوير البرامج التدريبية والأنشطة الموجهة لإعداد القيادات الشبابية وتنمية مهارات الطلاب في مختلف المجالات",
        ...
        hist_mohe_desc: "أصبح المعهد تحت إشراف وزارة التعليم العالي بالكامل، وتم تعديل المسمى لتقديم دورات تثقيفية مكثفة لشباب الجامعات.",
        hist_vm_title: "رؤيتنا ورسالتنا الحديثة",
        hist_vision_head: "رؤيتنا",
        hist_vision_text: "أن نكون المركز الرائد إقليمياً في صناعة القادة وإعداد الكوادر الشبابية القادرة على قيادة قاطرة التنمية.",
        ...
        second_about: "طالب بكلية علوم الحاسب و تكنولوجيا المعلومات جامعة حلوان الاهلية",
        third_name: "فرح سامح جابر",
        third_about: "طالبة بكلية علوم الحاسب و تكنولوجيا المعلومات جامعة حلوان الاهلية",
        fourth_name: "ياسين اسامه السيسي",
        fourth_about: "طالب بكلية علوم الحاسب و تكنولوجيا المعلومات جامعة حلوان الاهلية",
        fifth_name: "ماريا جرجس انور",
        fifth_about: "طالبة بكلية علوم الحاسب و تكنولوجيا المعلومات جامعة حلوان الاهلية",
        contact0: "تواصل معي",
        contact1: "تواصل معي",
        contact2: "تواصل معي",
        contact3: "تواصل معي",
        ...
        divider2: "مدير المعهد",
        divider_deputies: "وكلاء المعهد",
        divider3: "إداريون المعهد",
        // tech namessssss===================
    },
    ...
    en: {
        ...
        "it-box": "Information<br>Technology<br>Department",
        ...
        doc_mohamed_desc: "Assistant Professor Dr. Mohamed Abdel Fattah is an Assistant Professor at the Faculty of Social Work, Capital University (formerly Helwan University), and serves as the Deputy Director of the Leadership Preparation Institute. He contributes to the development of training programs and activities aimed at preparing young leaders and enhancing students' skills across various fields, supporting their personal, academic, and professional growth.",
        ...
        event1: "The Coordinative Training Program for the Coordinators of the National Reading Project",
        descEvent1: "The coordinative training program of the National Reading Project comes within the framework of cooperation between the Ministry of Higher Education and Scientific Research and the National Reading Project. It aims to prepare coordinators capable of spreading a culture of reading within universities, enhancing students' awareness, and establishing reading as a fundamental path for building individuals and shaping thought.",
        event2: "The 'Ambassadors of the Nation' training program for faculty members sent abroad",
        ...
        hist_desc_1919_2: "Accommodation initially relied on those kiosks and villas until the institute was transferred to the Ministry of Higher Education, beginning a journey of comprehensive development.",
        hist_acres: "Acres of Green Spaces",
        hist_nature_title: "Nature and English Architecture",
        hist_nature_desc: "The institute extends over a vast area, forming a green lung in the heart of Helwan. The consistent gardens and perennial trees are a 'sensory historical record' embodying the place's evolution.",
        hist_nature_quote: '"The Institute Theater... an architectural masterpiece designed by British Army engineers, retaining its unique character to witness the meeting of art and historic architecture."',
        hist_1941_title: "The Scout Camp",
        hist_1941_desc: "The General Administration of Sports and Military Education supervised it, and it was then called the 'Permanent Scout Camp'.",
        hist_national_title: "National Transformations",
        hist_national_desc: "Affiliation shifted between the Liberation Authority, the Socialist Union, and the Youth Organization, until it joined the Cairo Youth Directorate in 1968.",
        hist_mohe_title: "Ministry of Higher Education Era",
        hist_mohe_desc: "The institute came fully under the supervision of the Ministry of Higher Education, offering intensive educational courses for university youth.",
        hist_vm_title: "Our Modern Vision and Mission",
        hist_vision_head: "Our Vision",
        hist_vision_text: "To be the leading regional center in leadership industry and preparing youth cadres capable of leading development.",
        ...
        second_about: "Student at Faculty of Computer Science, Helwan National Univeristy ",
        third_name: "Farah Sameh ",
        third_about: "Student at at Faculty of Computer Science, Helwan National Univeristy",
        fourth_name: "Yassin Al-sisi",
        fourth_about: "Student at Faculty of Computer Science, Helwan National Univeristy",
        fifth_name: "Maria Gergs ",
        fifth_about: "Student at Faculty of Computer Science, Helwan National Univeristy",
        contact0: "Contact Me",
        contact1: "Contact Me",
        contact2: "Contact Me",
        contact3: "Contact Me",
